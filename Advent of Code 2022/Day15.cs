...
namespace Advent_of_Code_2022
{
    internal class Day15
    {
        ...
        public static void Run()
        {
            ...
            //I'm sure there's a proper mathy way to calculate this, but I suck at math.
        ...
        public static Sensor? FindSensorThatHasScannedThis(Point p, List<Sensor> sensors)
        {
            ...
            {
                if (Utils.ManhattanDistance(p, sensor.loc) <= sensor.distanceToBeacon)
                {
                    return sensor;
                }
            }
        ...
        public class Sensor
        {
            ...
            public Sensor(Point loc, Beacon nearestBeacon)
            {
                ...
                distanceToBeacon = Utils.ManhattanDistance(loc, nearestBeacon.loc);
            }
