...
namespace Advent_of_Code_2022
{
    internal class Day22
    {
        ...
        {
            (char[,], List<(int, char)>) processedInput = ProcessInput(input);

            Board board = new Board(processedInput.Item1);
            Player player = new Player(board.GetStarterPoint(), DIR_RIGHT, processedInput.Item2, board, '@');
        ...
        class Player
        {
            public Point loc;
            public int dir;
            public List<(int, char)> instructions;
            public Board board;
            public char sprite;

            public Player(Point loc, int dir, List<(int, char)> instructions, Board board, char sprite)
            {
                this.loc = loc;
                this.dir = dir;
            ...
            public void StartWalking()
            {
                ...
                {
                    (int times, char turn) instruction = instructions[0];
                    for (int i = 0; i < instruction.times; i++)
                    {
                        Point nextPoint = board.GetNextPoint(loc, dir);
        ...
        class Board
        {
            ...
            public Point GetNextPoint(Point start, int dir)
            {
        ...
        public static (char[,] grid, List<(int, char)> code) ProcessInput(string input)
        {
